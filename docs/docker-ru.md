...
**projects/001_my-company/specs/content.md** — контент и требования:
...
**projects/001_my-company/specs/technical.md** — визуальный дизайн:
...
projects/
  001_my-company/
    specs/
      ...
      technical.md      # Визуальный дизайн
...
Убедитесь, что в проекте есть директория `specs/` с файлами `content.md` и `technical.md`:
