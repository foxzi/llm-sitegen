...
2. [spec.md — контент](#specmd--контент)
3. [design.md — дизайн](#designmd--дизайн)
...
projects/
  001_my-project/
    specs/
      spec.md      # Обязательный: контент и содержимое сайта
      design.md    # Обязательный: визуальное оформление
...
### Пример полного spec.md

Смотрите примеры в папке `examples/`:
- `examples/electrolux-roseville/spec.md` — полный лендинг с Schema.org
- `examples/cleaning-service/spec.md` — с генерацией контента
- `examples/food-delivery/spec.md` — с изображениями
...
**Назначение:** Опциональный файл с дополнительными инструкциями, которые не вписываются в spec.md или design.md.
...
Спецификация в файле `spec.md`.
Дизайн в файле `design.md`.
...
Спецификация для создания сайта и контент в файле `spec.md`.
Технические детали по созданию сайта в файле `design.md`.
